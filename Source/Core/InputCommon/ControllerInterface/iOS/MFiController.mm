...
static GCControllerButtonInput* PreferPhysicalButton(GCController* controller,
                                                     GCControllerButtonInput* fallback,
                                                     NSArray<NSString*>* names)
{
  GCControllerButtonInput* button = FindPhysicalButton(controller, names);
  return button != nil ? button : fallback;
}
...
MFiController::MFiController(GCController* controller) : m_controller(controller)
{
  if (controller.extendedGamepad != nil)
  {
    ...
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonA, @[ @"Button A", @"A" ]),
                        "Button A"));
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonB, @[ @"Button B", @"B" ]),
                        "Button B"));
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonX, @[ @"Button X", @"X" ]),
                        "Button X"));
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonY, @[ @"Button Y", @"Y" ]),
                        "Button Y"));
...
#pragma clang diagnostic pop
  else if (controller.microGamepad != nil)  // Siri Remote
  {
    ...
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonA, @[ @"Button A", @"A" ]),
                        "Button A"));
    AddInput(new Button(PreferPhysicalButton(controller, nil, @[ @"Button B", @"B" ]),
                        "Button B"));
    AddInput(new Button(PreferPhysicalButton(controller, gamepad.buttonX, @[ @"Button X", @"X" ]),
                        "Button X"));
    AddInput(new Button(PreferPhysicalButton(controller, nil, @[ @"Button Y", @"Y" ]),
                        "Button Y"));
    AddInput(new Button(gamepad.buttonMenu, "Menu"));
  }
