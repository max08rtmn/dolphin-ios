...
static bool HasSeparatedJoyConPhysicalFaceButtons(GCController* controller)
{
...
MFiController::MFiController(GCController* controller) : m_controller(controller)
{
  ...
  if (HasSeparatedJoyConPhysicalFaceButtons(controller) && controller.extendedGamepad != nil)
  {
