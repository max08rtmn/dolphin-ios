...
MFiController::MFiController(GCController* controller) : m_controller(controller)
{
  ...
  if (HasSeparatedJoyConPhysicalButtons(controller))
  {
    ...
    add_physical_button(@[ @"Left Shoulder", @"Left Shoulder Button", @"Left Bumper", @"Button L",
                           @"L", @"L1" ],
                        "L Shoulder");
    add_physical_button(@[ @"Right Shoulder", @"Right Shoulder Button", @"Right Bumper", @"Button R",
                           @"R", @"R1" ],
                        "R Shoulder");

    GCControllerButtonInput* left_small_shoulder =
        FindPhysicalButton(controller, @[ @"Button SL", @"SL", @"Left SL", @"L SL" ]);
    ...
    GCControllerButtonInput* right_small_shoulder =
        FindPhysicalButton(controller, @[ @"Button SR", @"SR", @"Right SR", @"R SR" ]);
    ...
    const bool has_left_trigger =
        add_physical_button(@[ @"Left Trigger", @"Left Trigger Button", @"Button ZL", @"ZL", @"L2" ],
                            "L Trigger");
    const bool has_right_trigger =
        add_physical_button(@[ @"Right Trigger", @"Right Trigger Button", @"Button ZR", @"ZR", @"R2" ],
                            "R Trigger");
    ...
    add_physical_button(@[ @"Button Home", @"Home" ], "Home");
    add_physical_button(@[ @"Button Capture", @"Capture", @"Button Screenshot", @"Screenshot",
                           @"Button Share", @"Share" ],
                        "Capture");
    add_physical_button(@[ @"Button Capture", @"Capture", @"Button Screenshot", @"Screenshot",
                           @"Button Share", @"Share" ],
  ...
  else if (controller.extendedGamepad != nil)
  {
    ...
    GCControllerButtonInput* home_button = FindPhysicalButton(controller, @[ @"Button Home", @"Home" ]);
    if (home_button != nil)
    {
